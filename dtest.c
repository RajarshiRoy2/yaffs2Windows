...
void opendir_test(void)
{
	...
	yaffs_mkdir("/nand/x/raj",0666);

	try_opendir("nand/x/.");
	try_opendir("nand/x/raj");
...
void rmdir_test2(void)
{
	...
	//made a folder and added stuff
	//yaffs_mkdir("/nand/z111",0666);
	//try_opendir("nand/z111");
	//dump_directory_tree("/nand/");
	//try_rmdir("/nand/z/");
}
